...
const BreakingNewsBanner = () => {
  return (
    <motion.div
      ...
      className="w-full bg-gradient-to-r from-red-600 via-red-500 to-orange-500 text-white overflow-hidden"
    >
      <div className="container py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3 shrink-0">
            ...
            <button className="bg-white text-red-600 px-3 py-1 rounded-full text-xs font-bold hover:bg-white/90 transition-colors">
              Read All
            </button>
          </div>
        </div>
