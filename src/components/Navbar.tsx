    ...
    <nav className="bg-navbar text-navbar-foreground sticky top-0 z-50 backdrop-blur-md bg-navbar/95">
      <div className="container flex items-center justify-between py-3">
        <Link to="/" className="flex items-center gap-2 group shrink-0">
          ...
          <span className="font-heading font-bold text-navbar-foreground text-sm sm:text-lg md:text-2xl truncate max-w-[140px] sm:max-w-[220px] md:max-w-none">పొంగులేటి శ్రీనివాస రెడ్డి</span>
        </Link>
